<body style="padding:0px; margin:0px; background-color:#fff;font-family:arial,helvetica,sans-serif,verdana,'Open Sans'">
    ...
    <div id="jssor_1"
        ...
        <div data-u="slides"
            ...
            <div>
                <img data-u="image" data-src="{{ asset('data/slider/slider1.jpg') }}" />
            </div>

            <div>
                <img data-u="image" data-src="{{ asset('data/slider/slider2.jpg') }}" />
            </div>

            <div>
                <img data-u="image" data-src="{{ asset('data/slider/slider3.jpg') }}" />
            </div>

            <div>
                <img data-u="image" data-src="{{ asset('data/slider/slider4.jpg') }}" />
            </div>

            <div>
                <img data-u="image" data-src="{{ asset('data/slider/singapore-main-header.jpg') }}" />
            </div>
